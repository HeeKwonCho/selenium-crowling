...
try:    # 정상 처리
    ...
    theater_list = []
    pageNum = int(driver.find_element(By.CLASS_NAME, "_totalCount").text)
    count = 0
    
    for i in range(1, pageNum):
        theater_data = driver.find_elements(By.CLASS_NAME, "list_title")
        img_data = driver.find_elements(By.CLASS_NAME, "list_thumb")
        ...
        driver.find_element(By.XPATH, "//a[@class='btn_page_next _btnNext on']").click()
